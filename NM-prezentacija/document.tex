...
\frame{
  ...
  \item Profil slova
    \begin{itemize}
    \item Pronađe se najmanji pravokutnik koji omeđuje slovo
	\item Za svaku točku pravokutnika računa se najmanja udaljenost do slova
	\item Na taj način opisuje se vanjski oblik slova
    \end{itemize} 
  \end{itemize} 
}
