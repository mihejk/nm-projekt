...
%ovdje dolazi uklanjanje rubova
...
Radijalne neuronske mreže sastoje se od tri sloja - ulaznog, skrivenog i izlaznog sloja. U skrivenom se sloju koristi dolje navedena nelinearna skrivena funkcija, dok se u izlaznom sloju koristi linearna funkcija.
Skrivena funkcija za učenje: 
$\\exp^{-\left (b \left \| x - x_{i} \right \|  \right )^{2}}$, gdje je b prag. Centri se biraju među uzorcima iz skupa za učenje.       
